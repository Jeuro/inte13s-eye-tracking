...
namespace eyeProject2
{
    class Process : Form
    {
        ...
        public Process()
        {
            ...
            icons[3] = Image.FromFile(@"imgProject\Applications\trycatchNb.png");
            icons[4] = Image.FromFile(@"imgProject\Applications\ifelseNb.png");
            icons[5] = Image.FromFile(@"imgProject\Applications\foriNb.png");
            icons[8] = Image.FromFile(@"imgProject\Applications\Live Mail.png");
            icons[7] = Image.FromFile(@"imgProject\Web Browsers\chgoogle.png");
            icons[6] = Image.FromFile(@"imgProject\Web Browsers\chface.png");
